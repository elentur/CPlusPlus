...
#ifndef SDL_DEMO_FIGTHER_H
#define SDL_DEMO_FIGTHER_H
...
class Object {
    ...
    struct ObjectModel : ObjectConcept {
        ...
        virtual bool has_attack_concept() const { return object.can_attack(); }
...
/*int main() {
    ...
    backpack.push_back(Scroll());
    backpack.push_back(FireScroll());
    backpack.push_back(PoisonPotion());
    backpack.push_back(move(backpack));
