...
namespace my {
    ...
    public:
        ...
        */
        ...
        /**
            ...
            */
        my::Vec<T, N> &operator[](std::size_t index);
    ...
    */
    ...
    Mat<T, N>::Mat() : mArgs(std::array<my::Vec<T, N>, N>{}) {
    }

    template<typename T, int N>
    Mat<T, N>::Mat(std::initializer_list<my::Vec<T, N>> const &l) : mArgs(std::array<my::Vec<T, N>, N>{}) {
        assert(l.size() == N);
